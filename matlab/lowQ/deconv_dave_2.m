...
theta=10;       %  A first guess applied linearly to corr_time:
corr_time=0.1;   %  Only applies if less than the total h(t) length
% standard deviation of epistemic error (initial guess)
sigma = .231;
sigma_max= 0.4;   % DAB places a forced maximum on iterated sigma
% length of transfer-function vector (dt remains the same)
n_h=128;  
% number of realizations
nreal=20;  % Make 50 for nice final plots - takes a while
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
