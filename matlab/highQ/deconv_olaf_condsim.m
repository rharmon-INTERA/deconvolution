...
theta=155;   % Big numbers approximate delta correlation
% standard deviation of epistemic error (initial guess)
sigma = .172;
% length of transfer-function vector (dt remains the same)
n_h=64;
% number of realizations
nreal=10;  % Make 100 for nice final plots (after you know theta and sigma fairly closely)
% input signal
x=in;
% output signal
y=out;
