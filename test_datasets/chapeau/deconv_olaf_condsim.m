...
time = data.time;
in = data.in;
out = data.out; % three vectors of equal length: time, in, out
% slope of the linear variogram
theta=1e-6;   % Big numbers approximate delta correlation, but hard to converge!
